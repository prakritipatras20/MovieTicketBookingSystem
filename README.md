...
A console-based Movie Ticket Booking System built in C++ demonstrating core Object-Oriented Programming concepts and basic System Design principles — similar to how PVR or INOX works, but for a single cinema.
...
!\[Noun Verb Analysis](docs/noun\_verb.png)
...
| `Class Diagram`       | UML class diagram showing classes, attributes, methods and relationships |

| `noun\_verb`           | Noun-verb analysis used to identify classes and operations               |

| `Sequence Diagrams`   | Sequence diagrams showing interactions between objects                   |

| `SOLID PRINCIPLES`    | Documentation showing application of SOLID principles                    |
